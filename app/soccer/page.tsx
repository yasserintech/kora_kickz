    ...
    <main className="min-h-screen">
      ...
      <section className="relative h-[50vh] flex items-center justify-center">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6">Soccer Program</h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Our soccer program is designed to introduce children ages 3-10 to the fundamentals of soccer in a fun,
                supportive environment. Through age-appropriate drills, games, and activities, children develop
                coordination, teamwork, and a love for the sport.
              </p>
              <p className="text-gray-700 mb-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-xl font-bold text-center mb-4 text-red-600">Little Kickers (Ages 3-4)</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-xl font-bold text-center mb-4 text-red-600">Junior Strikers (Ages 5-7)</h3>
              <ul className="space-y-2 text-gray-700">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-xl font-bold text-center mb-4 text-red-600">Future Stars (Ages 8-10)</h3>
              <ul className="space-y-2 text-gray-700">
      ...
      <section className="py-16 bg-black text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Join Our Soccer Program?</h2>
